    ...
    <section className="py-20 md:py-24">
      <div className="container">
        ...
        <p className="text-white/70 text-lg md:text-xl text-center mt-5 tracking-tight max-w-sm mx-auto">
          Our revolutionary AI SEO tool have transformed our clients'
          strategies.
        </p>
          ...
          >
            {[...testimonials, ...testimonials].map((testimonial, index) => (
              <div
                ...
                className="border border-white/15 p-6 md:p-10 rounded-xl bg-[linear-gradient(to_bottom_left,rgba(140,69,255,.3),black)] max-w-xs md:max-w-md flex-none"
              >
                ...
                <div className="flex items-center gap-3 mt-5">
                 ...
                 before:border-white/30 before:z-10 before:rounded-lg"
                  >
                    <Image
