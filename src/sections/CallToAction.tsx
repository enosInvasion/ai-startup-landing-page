      ...
      <div className="container">
        ...
        >
          ...
          <div className="relative">
            <h2 className="text-5xl md:text-6xl max-w-md mx-auto text-white text-center font-medium">
              AI driven SEO for everyone.
            </h2>
            <p className="text-center text-lg md:text-xl max-w-xs mx-auto text-white/70 mt-5 tracking-tight">
