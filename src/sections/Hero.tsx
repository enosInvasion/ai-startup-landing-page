...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      {/* Planet start */}
      <div
        className="absolute h-64 w-64 md:h-96 md:w-96 bg-purple-500 rounded-full border
       ...
       shadow-[-20px_-20px_50px_rgba(255,255,255,.5),-20px_-20px_80px_rgba(255,255,255,.1),0_0_50px_rgb(140,69,255)]"
      ></div>
      {/* Planet end */}
      {/* Start ring 1 */}
      <motion.div
      ...
      <div className="container relative mt-16">
        <h1
         ...
         bg-white bg-[radial-gradient(100%_100%_at_top_left,white,white,rgba(74,32,138,.5))]
